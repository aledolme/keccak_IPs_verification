...
module pad_control_reg_top #(
  ...
  logic [3:0] pad_mux_pdm2pcm_pdm_qs;
  logic [3:0] pad_mux_pdm2pcm_pdm_wd;
  logic pad_mux_pdm2pcm_pdm_we;
  logic [3:0] pad_mux_pdm2pcm_clk_qs;
  logic [3:0] pad_mux_pdm2pcm_clk_wd;
  logic pad_mux_pdm2pcm_clk_we;
  logic [3:0] pad_mux_i2s_sck_qs;
  logic [3:0] pad_mux_i2s_sck_wd;
  logic pad_mux_i2s_sck_we;
  logic [3:0] pad_mux_i2s_ws_qs;
  logic [3:0] pad_mux_i2s_ws_wd;
  logic pad_mux_i2s_ws_we;
  logic [3:0] pad_mux_i2s_sd_qs;
  logic [3:0] pad_mux_i2s_sd_wd;
  logic pad_mux_i2s_sd_we;
  logic [3:0] pad_mux_spi2_cs_0_qs;
  logic [3:0] pad_mux_spi2_cs_0_wd;
  logic pad_mux_spi2_cs_0_we;
  logic [3:0] pad_mux_spi2_cs_1_qs;
  logic [3:0] pad_mux_spi2_cs_1_wd;
  logic pad_mux_spi2_cs_1_we;
  logic [3:0] pad_mux_spi2_sck_qs;
  logic [3:0] pad_mux_spi2_sck_wd;
  logic pad_mux_spi2_sck_we;
  logic [3:0] pad_mux_spi2_sd_0_qs;
  logic [3:0] pad_mux_spi2_sd_0_wd;
  logic pad_mux_spi2_sd_0_we;
  logic [3:0] pad_mux_spi2_sd_1_qs;
  logic [3:0] pad_mux_spi2_sd_1_wd;
  logic pad_mux_spi2_sd_1_we;
  logic [3:0] pad_mux_spi2_sd_2_qs;
  logic [3:0] pad_mux_spi2_sd_2_wd;
  logic pad_mux_spi2_sd_2_we;
  logic [3:0] pad_mux_spi2_sd_3_qs;
  logic [3:0] pad_mux_spi2_sd_3_wd;
  ...
  logic [7:0] pad_attribute_pdm2pcm_pdm_qs;
  logic [7:0] pad_attribute_pdm2pcm_pdm_wd;
  logic pad_attribute_pdm2pcm_pdm_we;
  logic [7:0] pad_attribute_pdm2pcm_clk_qs;
  logic [7:0] pad_attribute_pdm2pcm_clk_wd;
  logic pad_attribute_pdm2pcm_clk_we;
  logic [7:0] pad_attribute_i2s_sck_qs;
  logic [7:0] pad_attribute_i2s_sck_wd;
  logic pad_attribute_i2s_sck_we;
  logic [7:0] pad_attribute_i2s_ws_qs;
  logic [7:0] pad_attribute_i2s_ws_wd;
  logic pad_attribute_i2s_ws_we;
  logic [7:0] pad_attribute_i2s_sd_qs;
  logic [7:0] pad_attribute_i2s_sd_wd;
  logic pad_attribute_i2s_sd_we;
  logic [7:0] pad_attribute_spi2_cs_0_qs;
  logic [7:0] pad_attribute_spi2_cs_0_wd;
  logic pad_attribute_spi2_cs_0_we;
  logic [7:0] pad_attribute_spi2_cs_1_qs;
  logic [7:0] pad_attribute_spi2_cs_1_wd;
  logic pad_attribute_spi2_cs_1_we;
  logic [7:0] pad_attribute_spi2_sck_qs;
  logic [7:0] pad_attribute_spi2_sck_wd;
  logic pad_attribute_spi2_sck_we;
  logic [7:0] pad_attribute_spi2_sd_0_qs;
  logic [7:0] pad_attribute_spi2_sd_0_wd;
  logic pad_attribute_spi2_sd_0_we;
  logic [7:0] pad_attribute_spi2_sd_1_qs;
  logic [7:0] pad_attribute_spi2_sd_1_wd;
  logic pad_attribute_spi2_sd_1_we;
  logic [7:0] pad_attribute_spi2_sd_2_qs;
  logic [7:0] pad_attribute_spi2_sd_2_wd;
  logic pad_attribute_spi2_sd_2_we;
  logic [7:0] pad_attribute_spi2_sd_3_qs;
  logic [7:0] pad_attribute_spi2_sd_3_wd;
  logic pad_attribute_spi2_sd_3_we;
  ...
  // R[pad_attribute_pdm2pcm_pdm]: V(False)

  prim_subreg #(
      .DW      (8),
      .SWACCESS("RW"),
      .RESVAL  (8'h0)
  ) u_pad_attribute_pdm2pcm_pdm (
      .clk_i (clk_i),
      .rst_ni(rst_ni),

      // from register interface
      .we(pad_attribute_pdm2pcm_pdm_we),
      .wd(pad_attribute_pdm2pcm_pdm_wd),
      ...
      // to internal hardware
      .qe(),
      .q (reg2hw.pad_attribute_pdm2pcm_pdm.q),

      // to register interface (read)
      .qs(pad_attribute_pdm2pcm_pdm_qs)
  );


  // R[pad_attribute_pdm2pcm_clk]: V(False)

  prim_subreg #(
      .DW      (8),
      .SWACCESS("RW"),
      .RESVAL  (8'h0)
  ) u_pad_attribute_pdm2pcm_clk (
      .clk_i (clk_i),
      .rst_ni(rst_ni),

      // from register interface
      .we(pad_attribute_pdm2pcm_clk_we),
      .wd(pad_attribute_pdm2pcm_clk_wd),
      ...
      // to internal hardware
      .qe(),
      .q (reg2hw.pad_attribute_pdm2pcm_clk.q),

      // to register interface (read)
      .qs(pad_attribute_pdm2pcm_clk_qs)
  );


  // R[pad_attribute_i2s_sck]: V(False)

  prim_subreg #(
      .DW      (8),
      .SWACCESS("RW"),
      .RESVAL  (8'h0)
  ) u_pad_attribute_i2s_sck (
      .clk_i (clk_i),
      .rst_ni(rst_ni),

      // from register interface
      .we(pad_attribute_i2s_sck_we),
      .wd(pad_attribute_i2s_sck_wd),
      ...
      // to internal hardware
      .qe(),
      .q (reg2hw.pad_attribute_i2s_sck.q),

      // to register interface (read)
      .qs(pad_attribute_i2s_sck_qs)
  );


  // R[pad_attribute_i2s_ws]: V(False)

  prim_subreg #(
      .DW      (8),
      .SWACCESS("RW"),
      .RESVAL  (8'h0)
  ) u_pad_attribute_i2s_ws (
      .clk_i (clk_i),
      .rst_ni(rst_ni),

      // from register interface
      .we(pad_attribute_i2s_ws_we),
      .wd(pad_attribute_i2s_ws_wd),
      ...
      // to internal hardware
      .qe(),
      .q (reg2hw.pad_attribute_i2s_ws.q),

      // to register interface (read)
      .qs(pad_attribute_i2s_ws_qs)
  );


  // R[pad_attribute_i2s_sd]: V(False)

  prim_subreg #(
      .DW      (8),
      .SWACCESS("RW"),
      .RESVAL  (8'h0)
  ) u_pad_attribute_i2s_sd (
      .clk_i (clk_i),
      .rst_ni(rst_ni),

      // from register interface
      .we(pad_attribute_i2s_sd_we),
      .wd(pad_attribute_i2s_sd_wd),
      ...
      // to internal hardware
      .qe(),
      .q (reg2hw.pad_attribute_i2s_sd.q),

      // to register interface (read)
      .qs(pad_attribute_i2s_sd_qs)
  );


  // R[pad_attribute_spi2_cs_0]: V(False)

  prim_subreg #(
      .DW      (8),
      .SWACCESS("RW"),
      .RESVAL  (8'h0)
  ) u_pad_attribute_spi2_cs_0 (
      .clk_i (clk_i),
      .rst_ni(rst_ni),

      // from register interface
      .we(pad_attribute_spi2_cs_0_we),
      .wd(pad_attribute_spi2_cs_0_wd),
      ...
      // to internal hardware
      .qe(),
      .q (reg2hw.pad_attribute_spi2_cs_0.q),

      // to register interface (read)
      .qs(pad_attribute_spi2_cs_0_qs)
  );


  // R[pad_attribute_spi2_cs_1]: V(False)

  prim_subreg #(
      .DW      (8),
      .SWACCESS("RW"),
      .RESVAL  (8'h0)
  ) u_pad_attribute_spi2_cs_1 (
      .clk_i (clk_i),
      .rst_ni(rst_ni),

      // from register interface
      .we(pad_attribute_spi2_cs_1_we),
      .wd(pad_attribute_spi2_cs_1_wd),
      ...
      // to internal hardware
      .qe(),
      .q (reg2hw.pad_attribute_spi2_cs_1.q),

      // to register interface (read)
      .qs(pad_attribute_spi2_cs_1_qs)
  );


  // R[pad_attribute_spi2_sck]: V(False)

  prim_subreg #(
      .DW      (8),
      .SWACCESS("RW"),
      .RESVAL  (8'h0)
  ) u_pad_attribute_spi2_sck (
      .clk_i (clk_i),
      .rst_ni(rst_ni),

      // from register interface
      .we(pad_attribute_spi2_sck_we),
      .wd(pad_attribute_spi2_sck_wd),
      ...
      // to internal hardware
      .qe(),
      .q (reg2hw.pad_attribute_spi2_sck.q),

      // to register interface (read)
      .qs(pad_attribute_spi2_sck_qs)
  );


  // R[pad_attribute_spi2_sd_0]: V(False)

  prim_subreg #(
      .DW      (8),
      .SWACCESS("RW"),
      .RESVAL  (8'h0)
  ) u_pad_attribute_spi2_sd_0 (
      .clk_i (clk_i),
      .rst_ni(rst_ni),

      // from register interface
      .we(pad_attribute_spi2_sd_0_we),
      .wd(pad_attribute_spi2_sd_0_wd),
      ...
      // to internal hardware
      .qe(),
      .q (reg2hw.pad_attribute_spi2_sd_0.q),

      // to register interface (read)
      .qs(pad_attribute_spi2_sd_0_qs)
  );


  // R[pad_attribute_spi2_sd_1]: V(False)

  prim_subreg #(
      .DW      (8),
      .SWACCESS("RW"),
      .RESVAL  (8'h0)
  ) u_pad_attribute_spi2_sd_1 (
      .clk_i (clk_i),
      .rst_ni(rst_ni),

      // from register interface
      .we(pad_attribute_spi2_sd_1_we),
      .wd(pad_attribute_spi2_sd_1_wd),
      ...
      // to internal hardware
      .qe(),
      .q (reg2hw.pad_attribute_spi2_sd_1.q),

      // to register interface (read)
      .qs(pad_attribute_spi2_sd_1_qs)
  );


  // R[pad_attribute_spi2_sd_2]: V(False)

  prim_subreg #(
      .DW      (8),
      .SWACCESS("RW"),
      .RESVAL  (8'h0)
  ) u_pad_attribute_spi2_sd_2 (
      .clk_i (clk_i),
      .rst_ni(rst_ni),

      // from register interface
      .we(pad_attribute_spi2_sd_2_we),
      .wd(pad_attribute_spi2_sd_2_wd),
      ...
      // to internal hardware
      .qe(),
      .q (reg2hw.pad_attribute_spi2_sd_2.q),

      // to register interface (read)
      .qs(pad_attribute_spi2_sd_2_qs)
  );


  // R[pad_attribute_spi2_sd_3]: V(False)

  prim_subreg #(
      .DW      (8),
      .SWACCESS("RW"),
      .RESVAL  (8'h0)
  ) u_pad_attribute_spi2_sd_3 (
      .clk_i (clk_i),
      .rst_ni(rst_ni),

      // from register interface
      .we(pad_attribute_spi2_sd_3_we),
      .wd(pad_attribute_spi2_sd_3_wd),
      ...
      // to internal hardware
      .qe(),
      .q (reg2hw.pad_attribute_spi2_sd_3.q),

      // to register interface (read)
      .qs(pad_attribute_spi2_sd_3_qs)
  );
  ...
  always_comb begin
    ...
    addr_hit[14] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_CLK_OFFSET);
    addr_hit[15] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_RST_OFFSET);
    addr_hit[16] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_BOOT_SELECT_OFFSET);
    addr_hit[17] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_EXECUTE_FROM_FLASH_OFFSET);
    addr_hit[18] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TCK_OFFSET);
    addr_hit[19] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TMS_OFFSET);
    addr_hit[20] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TRST_OFFSET);
    addr_hit[21] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TDI_OFFSET);
    addr_hit[22] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TDO_OFFSET);
    addr_hit[23] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_UART_RX_OFFSET);
    addr_hit[24] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_UART_TX_OFFSET);
    addr_hit[25] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_EXIT_VALID_OFFSET);
    addr_hit[26] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_0_OFFSET);
    addr_hit[27] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_1_OFFSET);
    addr_hit[28] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_2_OFFSET);
    addr_hit[29] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_3_OFFSET);
    addr_hit[30] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_4_OFFSET);
    addr_hit[31] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_5_OFFSET);
    addr_hit[32] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_6_OFFSET);
    addr_hit[33] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_7_OFFSET);
    addr_hit[34] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_8_OFFSET);
    addr_hit[35] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_9_OFFSET);
    addr_hit[36] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_10_OFFSET);
    addr_hit[37] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_11_OFFSET);
    addr_hit[38] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_12_OFFSET);
    addr_hit[39] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_13_OFFSET);
    addr_hit[40] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_14_OFFSET);
    addr_hit[41] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_15_OFFSET);
    addr_hit[42] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_16_OFFSET);
    addr_hit[43] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_17_OFFSET);
    ...
    addr_hit[58] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_PDM2PCM_PDM_OFFSET);
    addr_hit[59] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_PDM2PCM_CLK_OFFSET);
    addr_hit[60] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_I2S_SCK_OFFSET);
    addr_hit[61] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_I2S_WS_OFFSET);
    addr_hit[62] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_I2S_SD_OFFSET);
    addr_hit[63] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_SPI2_CS_0_OFFSET);
    addr_hit[64] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_SPI2_CS_1_OFFSET);
    addr_hit[65] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_SPI2_SCK_OFFSET);
    addr_hit[66] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_SPI2_SD_0_OFFSET);
    addr_hit[67] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_SPI2_SD_1_OFFSET);
    addr_hit[68] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_SPI2_SD_2_OFFSET);
    addr_hit[69] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_SPI2_SD_3_OFFSET);
    addr_hit[70] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_I2C_SCL_OFFSET);
    addr_hit[71] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_I2C_SDA_OFFSET);
  end
  ...
  always_comb begin
    wr_err = (reg_we &
              ((addr_hit[ 0] & (|(PAD_CONTROL_PERMIT[ 0] & ~reg_be))) |
               ...
               (addr_hit[61] & (|(PAD_CONTROL_PERMIT[61] & ~reg_be))) |
               (addr_hit[62] & (|(PAD_CONTROL_PERMIT[62] & ~reg_be))) |
               (addr_hit[63] & (|(PAD_CONTROL_PERMIT[63] & ~reg_be))) |
               (addr_hit[64] & (|(PAD_CONTROL_PERMIT[64] & ~reg_be))) |
               (addr_hit[65] & (|(PAD_CONTROL_PERMIT[65] & ~reg_be))) |
               (addr_hit[66] & (|(PAD_CONTROL_PERMIT[66] & ~reg_be))) |
               (addr_hit[67] & (|(PAD_CONTROL_PERMIT[67] & ~reg_be))) |
               (addr_hit[68] & (|(PAD_CONTROL_PERMIT[68] & ~reg_be))) |
               (addr_hit[69] & (|(PAD_CONTROL_PERMIT[69] & ~reg_be))) |
               (addr_hit[70] & (|(PAD_CONTROL_PERMIT[70] & ~reg_be))) |
               (addr_hit[71] & (|(PAD_CONTROL_PERMIT[71] & ~reg_be)))));
  end

  assign pad_mux_pdm2pcm_pdm_we = addr_hit[0] & reg_we & !reg_error;
  assign pad_mux_pdm2pcm_pdm_wd = reg_wdata[3:0];

  assign pad_mux_pdm2pcm_clk_we = addr_hit[1] & reg_we & !reg_error;
  assign pad_mux_pdm2pcm_clk_wd = reg_wdata[3:0];

  assign pad_mux_i2s_sck_we = addr_hit[2] & reg_we & !reg_error;
  assign pad_mux_i2s_sck_wd = reg_wdata[3:0];

  assign pad_mux_i2s_ws_we = addr_hit[3] & reg_we & !reg_error;
  assign pad_mux_i2s_ws_wd = reg_wdata[3:0];

  assign pad_mux_i2s_sd_we = addr_hit[4] & reg_we & !reg_error;
  assign pad_mux_i2s_sd_wd = reg_wdata[3:0];

  assign pad_mux_spi2_cs_0_we = addr_hit[5] & reg_we & !reg_error;
  assign pad_mux_spi2_cs_0_wd = reg_wdata[3:0];

  assign pad_mux_spi2_cs_1_we = addr_hit[6] & reg_we & !reg_error;
  assign pad_mux_spi2_cs_1_wd = reg_wdata[3:0];

  assign pad_mux_spi2_sck_we = addr_hit[7] & reg_we & !reg_error;
  assign pad_mux_spi2_sck_wd = reg_wdata[3:0];

  assign pad_mux_spi2_sd_0_we = addr_hit[8] & reg_we & !reg_error;
  assign pad_mux_spi2_sd_0_wd = reg_wdata[3:0];

  assign pad_mux_spi2_sd_1_we = addr_hit[9] & reg_we & !reg_error;
  assign pad_mux_spi2_sd_1_wd = reg_wdata[3:0];

  assign pad_mux_spi2_sd_2_we = addr_hit[10] & reg_we & !reg_error;
  assign pad_mux_spi2_sd_2_wd = reg_wdata[3:0];

  assign pad_mux_spi2_sd_3_we = addr_hit[11] & reg_we & !reg_error;
  assign pad_mux_spi2_sd_3_wd = reg_wdata[3:0];
  ...
  assign pad_attribute_clk_we = addr_hit[14] & reg_we & !reg_error;
  assign pad_attribute_clk_wd = reg_wdata[7:0];

  assign pad_attribute_rst_we = addr_hit[15] & reg_we & !reg_error;
  assign pad_attribute_rst_wd = reg_wdata[7:0];

  assign pad_attribute_boot_select_we = addr_hit[16] & reg_we & !reg_error;
  assign pad_attribute_boot_select_wd = reg_wdata[7:0];

  assign pad_attribute_execute_from_flash_we = addr_hit[17] & reg_we & !reg_error;
  assign pad_attribute_execute_from_flash_wd = reg_wdata[7:0];

  assign pad_attribute_jtag_tck_we = addr_hit[18] & reg_we & !reg_error;
  assign pad_attribute_jtag_tck_wd = reg_wdata[7:0];

  assign pad_attribute_jtag_tms_we = addr_hit[19] & reg_we & !reg_error;
  assign pad_attribute_jtag_tms_wd = reg_wdata[7:0];

  assign pad_attribute_jtag_trst_we = addr_hit[20] & reg_we & !reg_error;
  assign pad_attribute_jtag_trst_wd = reg_wdata[7:0];

  assign pad_attribute_jtag_tdi_we = addr_hit[21] & reg_we & !reg_error;
  assign pad_attribute_jtag_tdi_wd = reg_wdata[7:0];

  assign pad_attribute_jtag_tdo_we = addr_hit[22] & reg_we & !reg_error;
  assign pad_attribute_jtag_tdo_wd = reg_wdata[7:0];

  assign pad_attribute_uart_rx_we = addr_hit[23] & reg_we & !reg_error;
  assign pad_attribute_uart_rx_wd = reg_wdata[7:0];

  assign pad_attribute_uart_tx_we = addr_hit[24] & reg_we & !reg_error;
  assign pad_attribute_uart_tx_wd = reg_wdata[7:0];

  assign pad_attribute_exit_valid_we = addr_hit[25] & reg_we & !reg_error;
  assign pad_attribute_exit_valid_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_0_we = addr_hit[26] & reg_we & !reg_error;
  assign pad_attribute_gpio_0_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_1_we = addr_hit[27] & reg_we & !reg_error;
  assign pad_attribute_gpio_1_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_2_we = addr_hit[28] & reg_we & !reg_error;
  assign pad_attribute_gpio_2_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_3_we = addr_hit[29] & reg_we & !reg_error;
  assign pad_attribute_gpio_3_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_4_we = addr_hit[30] & reg_we & !reg_error;
  assign pad_attribute_gpio_4_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_5_we = addr_hit[31] & reg_we & !reg_error;
  assign pad_attribute_gpio_5_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_6_we = addr_hit[32] & reg_we & !reg_error;
  assign pad_attribute_gpio_6_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_7_we = addr_hit[33] & reg_we & !reg_error;
  assign pad_attribute_gpio_7_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_8_we = addr_hit[34] & reg_we & !reg_error;
  assign pad_attribute_gpio_8_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_9_we = addr_hit[35] & reg_we & !reg_error;
  assign pad_attribute_gpio_9_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_10_we = addr_hit[36] & reg_we & !reg_error;
  assign pad_attribute_gpio_10_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_11_we = addr_hit[37] & reg_we & !reg_error;
  assign pad_attribute_gpio_11_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_12_we = addr_hit[38] & reg_we & !reg_error;
  assign pad_attribute_gpio_12_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_13_we = addr_hit[39] & reg_we & !reg_error;
  assign pad_attribute_gpio_13_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_14_we = addr_hit[40] & reg_we & !reg_error;
  assign pad_attribute_gpio_14_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_15_we = addr_hit[41] & reg_we & !reg_error;
  assign pad_attribute_gpio_15_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_16_we = addr_hit[42] & reg_we & !reg_error;
  assign pad_attribute_gpio_16_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_17_we = addr_hit[43] & reg_we & !reg_error;
  ...
  assign pad_attribute_pdm2pcm_pdm_we = addr_hit[58] & reg_we & !reg_error;
  assign pad_attribute_pdm2pcm_pdm_wd = reg_wdata[7:0];

  assign pad_attribute_pdm2pcm_clk_we = addr_hit[59] & reg_we & !reg_error;
  assign pad_attribute_pdm2pcm_clk_wd = reg_wdata[7:0];

  assign pad_attribute_i2s_sck_we = addr_hit[60] & reg_we & !reg_error;
  assign pad_attribute_i2s_sck_wd = reg_wdata[7:0];

  assign pad_attribute_i2s_ws_we = addr_hit[61] & reg_we & !reg_error;
  assign pad_attribute_i2s_ws_wd = reg_wdata[7:0];

  assign pad_attribute_i2s_sd_we = addr_hit[62] & reg_we & !reg_error;
  assign pad_attribute_i2s_sd_wd = reg_wdata[7:0];

  assign pad_attribute_spi2_cs_0_we = addr_hit[63] & reg_we & !reg_error;
  assign pad_attribute_spi2_cs_0_wd = reg_wdata[7:0];

  assign pad_attribute_spi2_cs_1_we = addr_hit[64] & reg_we & !reg_error;
  assign pad_attribute_spi2_cs_1_wd = reg_wdata[7:0];

  assign pad_attribute_spi2_sck_we = addr_hit[65] & reg_we & !reg_error;
  assign pad_attribute_spi2_sck_wd = reg_wdata[7:0];

  assign pad_attribute_spi2_sd_0_we = addr_hit[66] & reg_we & !reg_error;
  assign pad_attribute_spi2_sd_0_wd = reg_wdata[7:0];

  assign pad_attribute_spi2_sd_1_we = addr_hit[67] & reg_we & !reg_error;
  assign pad_attribute_spi2_sd_1_wd = reg_wdata[7:0];

  assign pad_attribute_spi2_sd_2_we = addr_hit[68] & reg_we & !reg_error;
  assign pad_attribute_spi2_sd_2_wd = reg_wdata[7:0];

  assign pad_attribute_spi2_sd_3_we = addr_hit[69] & reg_we & !reg_error;
  assign pad_attribute_spi2_sd_3_wd = reg_wdata[7:0];

  assign pad_attribute_i2c_scl_we = addr_hit[70] & reg_we & !reg_error;
  assign pad_attribute_i2c_scl_wd = reg_wdata[7:0];

  assign pad_attribute_i2c_sda_we = addr_hit[71] & reg_we & !reg_error;
  ...
  always_comb begin
    ...
    unique case (1'b1)
      addr_hit[0]: begin
        reg_rdata_next[3:0] = pad_mux_pdm2pcm_pdm_qs;
      end

      addr_hit[1]: begin
        reg_rdata_next[3:0] = pad_mux_pdm2pcm_clk_qs;
      end

      addr_hit[2]: begin
        reg_rdata_next[3:0] = pad_mux_i2s_sck_qs;
      end

      addr_hit[3]: begin
        reg_rdata_next[3:0] = pad_mux_i2s_ws_qs;
      end

      addr_hit[4]: begin
        reg_rdata_next[3:0] = pad_mux_i2s_sd_qs;
      end

      addr_hit[5]: begin
        reg_rdata_next[3:0] = pad_mux_spi2_cs_0_qs;
      end

      addr_hit[6]: begin
        reg_rdata_next[3:0] = pad_mux_spi2_cs_1_qs;
      end

      addr_hit[7]: begin
        reg_rdata_next[3:0] = pad_mux_spi2_sck_qs;
      end

      addr_hit[8]: begin
        reg_rdata_next[3:0] = pad_mux_spi2_sd_0_qs;
      end

      addr_hit[9]: begin
        reg_rdata_next[3:0] = pad_mux_spi2_sd_1_qs;
      end

      addr_hit[10]: begin
        reg_rdata_next[3:0] = pad_mux_spi2_sd_2_qs;
      end

      addr_hit[11]: begin
        reg_rdata_next[3:0] = pad_mux_spi2_sd_3_qs;
      end
      ...
      addr_hit[58]: begin
        reg_rdata_next[7:0] = pad_attribute_pdm2pcm_pdm_qs;
      end

      addr_hit[59]: begin
        reg_rdata_next[7:0] = pad_attribute_pdm2pcm_clk_qs;
      end

      addr_hit[60]: begin
        reg_rdata_next[7:0] = pad_attribute_i2s_sck_qs;
      end

      addr_hit[61]: begin
        reg_rdata_next[7:0] = pad_attribute_i2s_ws_qs;
      end

      addr_hit[62]: begin
        reg_rdata_next[7:0] = pad_attribute_i2s_sd_qs;
      end

      addr_hit[63]: begin
        reg_rdata_next[7:0] = pad_attribute_spi2_cs_0_qs;
      end

      addr_hit[64]: begin
        reg_rdata_next[7:0] = pad_attribute_spi2_cs_1_qs;
      end

      addr_hit[65]: begin
        reg_rdata_next[7:0] = pad_attribute_spi2_sck_qs;
      end

      addr_hit[66]: begin
        reg_rdata_next[7:0] = pad_attribute_spi2_sd_0_qs;
      end

      addr_hit[67]: begin
        reg_rdata_next[7:0] = pad_attribute_spi2_sd_1_qs;
      end

      addr_hit[68]: begin
        reg_rdata_next[7:0] = pad_attribute_spi2_sd_2_qs;
      end

      addr_hit[69]: begin
        reg_rdata_next[7:0] = pad_attribute_spi2_sd_3_qs;
      end
